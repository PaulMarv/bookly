...
@book_router.patch("/{book_uid}", response_model=BookUpdate)
async def update_book(book_uid: int, book_update_data: BookUpdate, session:AsyncSession=Depends(get_session)):
